...
| Memory read | 25,645.48 MiB/sec | **29,606.82 MiB/sec** |
| Memory write | 21,665.73 MiB/sec | **25,190.33 MiB/sec** |
...
* 32 GB dual-channel memory versus the current 16 GB single-module configuration
